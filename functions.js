...
function add_set() {
    ...
    let exercise_ctrl = document.getElementById("exercise");
    let weight_ctrl = document.getElementById("weight");
    let reps_ctrl = document.getElementById("reps");
    // get exercise
...
function build_table() {
    ...
    exercise_head.textContent = "Exercise";
